        ...
        {settingsTab === 'Profile' ? (
          <div style={{ padding: '24px 22px' }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4" style={{ marginBottom: 24 }}>
              ...
              <div><label style={{ display: 'block', fontSize: 13, fontWeight: 600, color: 'var(--accent)', marginBottom: 6 }}>Department</label><input type="text" defaultValue={profile?.unit || ''} readOnly style={{ width: '100%', padding: '10px 14px', borderRadius: 'var(--radius-sm)', border: '1.5px solid var(--surface)', background: 'var(--surface-soft)', fontSize: 13, color: 'var(--text)', cursor: 'default' }} /></div>
              <div><label style={{ display: 'block', fontSize: 13, fontWeight: 600, color: 'var(--accent)', marginBottom: 6 }}>Phone Number</label><input type="text" defaultValue={profile?.phone || ''} readOnly style={{ width: '100%', padding: '10px 14px', borderRadius: 'var(--radius-sm)', border: '1.5px solid var(--surface)', background: 'var(--surface-soft)', fontSize: 13, color: 'var(--text)', cursor: 'default' }} /></div>
            </div>
            )}
          </div>
          ...
          <div style={{ padding: '24px 22px' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
              <h3 style={{ fontSize: 15, fontWeight: 700, color: 'var(--accent)', display: 'flex', alignItems: 'center', gap: 8 }}><ShieldCheck size={16} /> Security</h3>
            </div>
            <SecuritySettings />
          </div>
